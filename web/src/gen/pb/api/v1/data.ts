...
class ListDashboardsResponse$Type extends MessageType<ListDashboardsResponse> {
  ...
  create(
    value?: PartialMessage<ListDashboardsResponse>
      ...
      switch (fieldNo) {
        case /* repeated testgrid.api.v1.DashboardResource dashboards */ 1:
          message.dashboards.push(
            DashboardResource.internalBinaryRead(
              reader,
              reader.uint32(),
              options
            )
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.dashboards.length; i++)
      DashboardResource.internalBinaryWrite(
...
class ListDashboardGroupsRequest$Type extends MessageType<ListDashboardGroupsRequest> {
  ...
  create(
    value?: PartialMessage<ListDashboardGroupsRequest>
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: ListDashboardGroupsRequest
  ): ListDashboardGroupsRequest {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
  ...
  internalBinaryWrite(
    message: ListDashboardGroupsRequest,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    /* string scope = 1; */
...
class ListDashboardGroupsResponse$Type extends MessageType<ListDashboardGroupsResponse> {
  ...
  create(
    value?: PartialMessage<ListDashboardGroupsResponse>
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: ListDashboardGroupsResponse
  ): ListDashboardGroupsResponse {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
  ...
  internalBinaryWrite(
    message: ListDashboardGroupsResponse,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
 ...
 */
export const ListDashboardGroupsResponse =
  new ListDashboardGroupsResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
class DashboardResource$Type extends MessageType<DashboardResource> {
  ...
  create(value?: PartialMessage<DashboardResource>): DashboardResource {
    const message = { name: '', link: '', dashboardGroupName: '' };
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, {
      enumerable: false,
      value: this,
    });
  ...
  internalBinaryWrite(
    ...
    if (message.dashboardGroupName !== '')
      writer
        ...
        .string(message.dashboardGroupName);
    let u = options.writeUnknownFields;
    if (u !== false)
      (u == true ? UnknownFieldHandler.onWrite : u)(
        this.typeName,
...
export const TestGridData = new ServiceType('testgrid.api.v1.TestGridData', [
  ...
  },
  {
    ...
    options: {},
    I: ListDashboardGroupsRequest,
    O: ListDashboardGroupsResponse,
  },
  {
