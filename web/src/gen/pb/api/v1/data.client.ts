...
export interface ITestGridDataClient {
  ...
  listDashboards(
    ...
    options?: RpcOptions
  ): UnaryCall<ListDashboardsRequest, ListDashboardsResponse>;
  /**
   ...
   */
  listDashboardGroups(
    input: ListDashboardGroupsRequest,
    options?: RpcOptions
  ): UnaryCall<ListDashboardGroupsRequest, ListDashboardGroupsResponse>;
  /**
...
export class TestGridDataClient implements ITestGridDataClient, ServiceInfo {
  ...
  listDashboards(
    ...
    return stackIntercept<ListDashboardsRequest, ListDashboardsResponse>(
      'unary',
      this._transport,
      method,
      opt,
