...
class TestNameConfig$Type extends MessageType<TestNameConfig> {
    constructor() {
        super("testgrid.config.TestNameConfig", [
            { no: 1, name: "name_elements", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => TestNameConfig_NameElement },
...
class TestGroup$Type extends MessageType<TestGroup> {
    constructor() {
        super("testgrid.config.TestGroup", [
            ...
            { no: 9, name: "column_header", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => TestGroup_ColumnHeader },
            ...
            { no: 27, name: "notifications", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Notification },
            ...
            { no: 31, name: "test_annotations", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => TestGroup_TestAnnotation },
            { no: 32, name: "max_test_methods_per_test", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 34, name: "test_metadata_options", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => TestMetadataOptions },
            ...
            { no: 41, name: "test_method_properties", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => TestGroup_KeyValue },
    ...
    create(value?: PartialMessage<TestGroup>): TestGroup {
        ...
        message.name = "";
        message.gcsPrefix = "";
        message.daysOfResults = 0;
        message.ignorePending = false;
        message.ignoreBuilt = false;
        message.testsNamePolicy = 0;
        message.ignoreTestSubstring = [];
        message.columnHeader = [];
        message.fallbackGrouping = 0;
        message.alertStaleResultsHours = 0;
        message.numFailuresToAlert = 0;
        message.bugComponent = 0;
        message.codeSearchPath = "";
        message.numColumnsRecent = 0;
        message.useTestMetadata = false;
        message.alertMailToAddresses = "";
        message.alertMailSubject = "";
        message.alertMailFailureMessage = "";
        message.alertMailDebugUrl = "";
        message.minElapsedMinutesBetweenMails = 0;
        message.enableFlakyStatus = false;
        message.disableMergedStatus = false;
        message.useKubernetesClient = false;
        message.disableProwjobAnalysis = false;
        message.isExternal = false;
        message.notifications = [];
        message.primaryGrouping = 0;
        message.enableTestMethods = false;
        message.testAnnotations = [];
        message.maxTestMethodsPerTest = 0;
        message.testMetadataOptions = [];
        message.testTagPattern = "";
        message.maxTestRuntimeHours = 0;
        message.numPassesToDisableAlert = 0;
        message.linkBugsByGroup = false;
        message.testMethodProperties = [];
        message.gatherBugs = false;
        message.shortTextMetric = "";
        message.buildOverrideConfigurationValue = "";
        message.linkBugsByTestMethods = false;
        message.testMethodMatchRegex = "";
        message.testMethodUnmatchRegex = "";
        message.useFullMethodNames = false;
        message.fallbackGroupingConfigurationValue = "";
        message.readStateFromStorage = false;
        message.ignoreOldResults = false;
        message.ignoreSkip = false;
        message.buildOverrideStrftime = "";
...
class TestGroup_TestAnnotation$Type extends MessageType<TestGroup_TestAnnotation> {
    ...
    create(value?: PartialMessage<TestGroup_TestAnnotation>): TestGroup_TestAnnotation {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.shortText = "";
        message.shortTextMessageSource = { oneofKind: undefined };
        if (value !== undefined)
...
class TestGroup_ResultSource$Type extends MessageType<TestGroup_ResultSource> {
    ...
    create(value?: PartialMessage<TestGroup_ResultSource>): TestGroup_ResultSource {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.resultSourceConfig = { oneofKind: undefined };
        if (value !== undefined)
...
class AutoBugOptions$Type extends MessageType<AutoBugOptions> {
    constructor() {
        super("testgrid.config.AutoBugOptions", [
            ...
            { no: 4, name: "hotlist_ids_from_source", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => HotlistIdFromSource },
    ...
    create(value?: PartialMessage<AutoBugOptions>): AutoBugOptions {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.betaAutobugComponent = 0;
        message.autoClose = false;
        message.hotlistIds = [];
        message.priority = 0;
        message.hotlistIdsFromSource = [];
        message.fileIndividual = false;
        message.singletonAutobug = false;
        message.maxAllowedIndividualBugs = 0;
        message.fileOverall = false;
        message.advancedTestMetadata = false;
        message.fileStale = false;
        message.ignoreOverall = false;
        message.note = "";
        if (value !== undefined)
...
class HotlistIdFromSource$Type extends MessageType<HotlistIdFromSource> {
    ...
    create(value?: PartialMessage<HotlistIdFromSource>): HotlistIdFromSource {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.hotlistIdSource = { oneofKind: undefined };
        if (value !== undefined)
...
class Dashboard$Type extends MessageType<Dashboard> {
    constructor() {
        super("testgrid.config.Dashboard", [
            { no: 1, name: "dashboard_tab", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => DashboardTab },
    ...
    create(value?: PartialMessage<Dashboard>): Dashboard {
        ...
        message.notifications = [];
        message.defaultTab = "";
        message.downplayFailingTabs = false;
        message.highlightFailingTabs = false;
...
class LinkTemplate$Type extends MessageType<LinkTemplate> {
    constructor() {
        super("testgrid.config.LinkTemplate", [
            ...
            { no: 2, name: "options", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => LinkOptionsTemplate },
...
class DashboardTab$Type extends MessageType<DashboardTab> {
    constructor() {
        super("testgrid.config.DashboardTab", [
            ...
            { no: 25, name: "column_diff_link_templates", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => LinkTemplate }
        ]);
    }
    create(value?: PartialMessage<DashboardTab>): DashboardTab {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.name = "";
        message.testGroupName = "";
        message.bugComponent = 0;
        message.codeSearchPath = "";
        message.numColumnsRecent = 0;
        message.baseOptions = "";
        message.resultsText = "";
        message.description = "";
        message.tabularNamesRegex = "";
        message.aboutDashboardUrl = "";
        message.autoFileBugs = false;
        message.displayLocalTime = false;
        message.brokenColumnThreshold = 0;
        message.columnDiffLinkTemplates = [];
        if (value !== undefined)
...
class DashboardTabAlertOptions$Type extends MessageType<DashboardTabAlertOptions> {
    ...
    create(value?: PartialMessage<DashboardTabAlertOptions>): DashboardTabAlertOptions {
        ...
        message.waitMinutesBetweenEmails = 0;
        message.alertMailFailureMessage = "";
        if (value !== undefined)
...
class DashboardTabFlakinessAlertOptions$Type extends MessageType<DashboardTabFlakinessAlertOptions> {
    ...
    create(value?: PartialMessage<DashboardTabFlakinessAlertOptions>): DashboardTabFlakinessAlertOptions {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.minimumFlakinessToAlert = 0;
        message.alertMailToAddresses = "";
        message.subject = "";
        message.waitMinutesBetweenEmails = 0;
        message.alertMailFailureMessage = "";
...
class DashboardTabStatusCustomizationOptions$Type extends MessageType<DashboardTabStatusCustomizationOptions> {
    ...
    create(value?: PartialMessage<DashboardTabStatusCustomizationOptions>): DashboardTabStatusCustomizationOptions {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.maxAcceptableFlakiness = 0;
        message.ignoredTestStatuses = [];
        message.minAcceptableRuns = 0;
        if (value !== undefined)
...
class Configuration$Type extends MessageType<Configuration> {
    constructor() {
        super("testgrid.config.Configuration", [
            { no: 1, name: "test_groups", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => TestGroup },
            { no: 2, name: "dashboards", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Dashboard },
            { no: 3, name: "dashboard_groups", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => DashboardGroup }
        ]);
    }
...
class HealthAnalysisOptions$Type extends MessageType<HealthAnalysisOptions> {
    ...
    create(value?: PartialMessage<HealthAnalysisOptions>): HealthAnalysisOptions {
        ...
        message.daysOfAnalysis = 0;
        message.emailSchedule = "";
        message.emailRecipients = "";
        message.groupingRegex = "";
        if (value !== undefined)
