...
class FailingTestSummary$Type extends MessageType<FailingTestSummary> {
    ...
    create(value?: PartialMessage<FailingTestSummary>): FailingTestSummary {
        ...
        message.testName = "";
        message.failBuildId = "";
        message.failTimestamp = 0;
        message.passBuildId = "";
        message.passTimestamp = 0;
        message.failCount = 0;
        message.buildLink = "";
        message.buildLinkText = "";
        message.buildUrlText = "";
        message.failureMessage = "";
        message.linkedBugs = [];
        message.failTestLink = "";
        message.latestFailTestLink = "";
        message.latestFailBuildId = "";
        message.properties = {};
        message.hotlistIds = [];
        message.emailAddresses = [];
        message.customColumnHeaders = {};
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for testgrid.summary.FailingTestSummary.properties");
            }
        }
        map[key ?? ""] = val ?? "";
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for testgrid.summary.FailingTestSummary.custom_column_headers");
            }
        }
        map[key ?? ""] = val ?? "";
    }
    internalBinaryWrite(message: FailingTestSummary, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let k of globalThis.Object.keys(message.customColumnHeaders))
...
class TestInfo$Type extends MessageType<TestInfo> {
    ...
    create(value?: PartialMessage<TestInfo>): TestInfo {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.displayName = "";
        message.totalNonInfraRuns = 0;
        message.passedNonInfraRuns = 0;
        message.failedNonInfraRuns = 0;
        message.failedInfraRuns = 0;
        message.totalRunsWithInfra = 0;
        message.otherRuns = 0;
        message.flakiness = 0;
        message.previousFlakiness = [];
        message.changeFromLastInterval = 0;
        message.infraFailures = {};
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.int32();
                    break;
                default: throw new globalThis.Error("unknown map entry field for testgrid.summary.TestInfo.infra_failures");
            }
        }
        map[key ?? ""] = val ?? 0;
    }
    internalBinaryWrite(message: TestInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let k of globalThis.Object.keys(message.infraFailures))
...
class HealthinessInfo$Type extends MessageType<HealthinessInfo> {
    constructor() {
        super("testgrid.summary.HealthinessInfo", [
            ...
            { no: 3, name: "tests", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => TestInfo },
...
class DashboardTabSummary$Type extends MessageType<DashboardTabSummary> {
    constructor() {
        super("testgrid.summary.DashboardTabSummary", [
            ...
            { no: 4, name: "failing_test_summaries", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => FailingTestSummary },
    ...
    create(value?: PartialMessage<DashboardTabSummary>): DashboardTabSummary {
        ...
        message.alert = "";
        message.failingTestSummaries = [];
        message.lastUpdateTimestamp = 0;
        message.status = "";
        message.overallStatus = 0;
        message.latestGreen = "";
        message.lastRunTimestamp = 0;
        message.bugUrl = "";
        message.linkedIssues = [];
        message.acceptablyFlaky = false;
        if (value !== undefined)
...
class DashboardTabSummaryMetrics$Type extends MessageType<DashboardTabSummaryMetrics> {
    ...
    create(value?: PartialMessage<DashboardTabSummaryMetrics>): DashboardTabSummaryMetrics {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.completedColumns = 0;
        message.passingColumns = 0;
        message.ignoredColumns = 0;
        if (value !== undefined)
...
class DashboardSummary$Type extends MessageType<DashboardSummary> {
    constructor() {
        super("testgrid.summary.DashboardSummary", [
            { no: 1, name: "tab_summaries", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => DashboardTabSummary }
        ]);
    }
