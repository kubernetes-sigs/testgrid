...
class Property$Type extends MessageType<Property> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for testgrid.state.Property.property");
            }
        }
        map[key ?? ""] = val ?? "";
    }
    internalBinaryWrite(message: Property, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let k of globalThis.Object.keys(message.property))
...
class UpdateInfo$Type extends MessageType<UpdateInfo> {
    constructor() {
        super("testgrid.state.UpdateInfo", [
            { no: 1, name: "update_phase_data", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => UpdatePhaseData }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for testgrid.state.AlertInfo.properties");
            }
        }
        map[key ?? ""] = val ?? "";
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for testgrid.state.AlertInfo.custom_column_headers");
            }
        }
        map[key ?? ""] = val ?? "";
    }
...
class Row$Type extends MessageType<Row> {
    constructor() {
        super("testgrid.state.Row", [
            ...
            { no: 8, name: "metrics", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Metric },
            ...
            { no: 13, name: "properties", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Property }
        ]);
    }
...
class Grid$Type extends MessageType<Grid> {
    constructor() {
        super("testgrid.state.Grid", [
            ...
            { no: 8, name: "update_info", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => UpdateInfo },
            { no: 9, name: "test_metadata", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => TestMetadata },
            { no: 10, name: "cluster", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Cluster },
    ...
    create(value?: PartialMessage<Grid>): Grid {
        ...
        message.columns = [];
        message.rows = [];
        message.lastTimeUpdated = 0;
        message.updateInfo = [];
        message.testMetadata = [];
        message.cluster = [];
        message.mostRecentClusterTimestamp = 0;
        if (value !== undefined)
...
class Cluster$Type extends MessageType<Cluster> {
    constructor() {
        super("testgrid.state.Cluster", [
            ...
            { no: 3, name: "cluster_row", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ClusterRow }
        ]);
    }
    create(value?: PartialMessage<Cluster>): Cluster {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.testStatus = 0;
        message.message = "";
        message.clusterRow = [];
        if (value !== undefined)
